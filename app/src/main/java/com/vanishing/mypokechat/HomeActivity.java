...
import com.vanishing.mypokechat.adapters.PaginasAdapter;
import com.vanishing.mypokechat.pojos.Estado;
         ...
         TabLayoutMediator tabLayoutMediator = new TabLayoutMediator(tabLayout, viewPager2, new TabLayoutMediator.TabConfigurationStrategy() {
             ...
             public void onConfigureTab(@NonNull TabLayout.Tab tab, int position) {
                 switch (position){
                     case 0:{
                         tab.setText("Users");
                         tab.setIcon(R.drawable.ic_equipoamarillo);
                         break;
                     }
                     case 1:{
                         tab.setText("Chats");
                         tab.setIcon(R.drawable.ic_equipoazul);
                         break;
                     }
                     case 2:{
                         tab.setText("Solicitudes");
                         tab.setIcon(R.drawable.ic_equiporojo);
                     ...
                     case 3:{
                         ...
                         tab.setIcon(R.drawable.ic_crown_icon_icons_com_67567);
                         break;
                     }
                 }
             }
